...
def run_test():
    ...
    extracted = extract_skills(dummy_cv)
    print("Extracted output:", extracted)
    
    skills = extracted.get("skills", []) if isinstance(extracted, dict) else extracted
    ...
    print("[SUCCESS] Test passed! False-positive 'Java' problem is solved.")
